		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{url('index')}}"><img src="img/logo.png" alt=""></a>
    ...
    <section class="banner-area organic-breadcrumb">
        <div class="container">
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                ...
                <div class="col-first">
                    <h1 style="color: #0a2b1d">Shopping Cart</h1>
                    ...
                    <div class="single-product">
                        <img class="img-fluid" src="{{asset('assets/img/bag.png')}}" class="img-thumbnail card-img" alt="">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h5>DL {{$product->price}}</h5>
                                </td>
                                <td>
                                    <div class="col-md-6">
                                    <div class="single-product">
                                        <img class="img-fluid" src="{{asset("storage/product_image/".$product->url)}}" width="100"class="img-thumbnail card-img" height="100" alt="">
                                        <div class="product-details">
                                        </div>
                                </td>
                                <td>
